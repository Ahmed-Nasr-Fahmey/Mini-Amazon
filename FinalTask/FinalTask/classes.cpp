...
void Seller::SwitchSellerToCustomer()
{
	...
	else
	{
		...
		customerObj.setCustomerPassword(sellerObj.getSellerPassword());
		...
		outCustomer << customerObj.getcustomerID() << " " << customerObj.getCustomerName() << " " << customerObj.getCustomerEmail() << " " << customerObj.getCustomerPassword() << " " << customerObj.getCustomerAddress() << " " << customerObj.getCustomerPhoneNumber()<< endl;
...
void Seller::addNewSeller()
{
	...
	while (true)
	{
		...
		{
			cout << "Invalid password, The password must be at least 4 characters or numbers :\n";
		}
	}
...
void Seller::loginAsSeller()
{
	...
	for (int i = 0; i < sellerLinkedList.Length(); i++)
	{
		...
		if (sellerObj.getSellerEmail() == enteredEmail && sellerObj.getSellerPassword() == enteredPassword)
		{
...
void Customer::switchCustomerToSeller()
{
	...
	else
	{
		...
		sellerObj.setSellerPassword(customerObj.getCustomerPassword());

		sellerObj.setSellerEmail(customerObj.getCustomerEmail());

		fstream outSeller("Seller.txt", ios::app);

		outSeller << sellerObj.getSellerID() << " " << sellerObj.getSellerName() << " " << sellerObj.getSellerEmail() << " " << sellerObj.getSellerPassword() << endl;
...
void Customer::loginAsCustomer()
{
	...
	for (int i = 0; i < customerLinkedList.Length(); i++)
	{
		...
		if (customerObj.getCustomerEmail() == enteredEmail && customerObj.getCustomerPassword() == enteredPassword)
		{
